...
Login form
- /questions
A list of quiz(question-choices).
- /questions/[questionId]
An indivisual question
- /questions/[questionId]/edit
Edit form for An indivisual question
- /questions/new
A form for question-choice creation.
...
(in `src`)
- question
has question text for quiz, Create, Update, Delete logic.
- choice
A question has Multiple choices. Update logic.
...
### Known Issues
- [A new app generated by blitz new causes Error: DYNAMIC_SERVER_USAGE](https://github.com/blitz-js/blitz/issues/4112)
Use nextjs v13.2.4
